...
int main(int argc, char *argv[])
{
	...
	//timej=GetTicks();
		...
		//for(i=0;i<50;i++)
			//for(j=0;j<50;j++)
				DrawSprite(8192,4096,2048,2048,0,255,255,255,mgg[0].frames[1],1,0);
				DrawSprite(8192,4096,2048,2048,0,255,255,255,mgg[0].frames[2],1,2048);
				//DrawSprite(1024,2048,2048,2048,0,255,255,255,mgg[0].frames[1],1,0);
