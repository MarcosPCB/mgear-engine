...
int main(int argc, char *argv[])
{
	...
	//timej=GetTicks();
		...
		for(i=0;i<100;i++)
			for(j=0;j<50;j++)
				DrawSprite(j*32,i*32,32,32,0,255,255,255,mgg[0].frames[1],1,0);
				//DrawSprite(4096,4096,1024,1024,0,255,255,255,mgg[0].frames[1],1,0);
				//DrawSprite(12288,4096,1024,1024,0,255,255,255,mgg[0].frames[1],1,0);
