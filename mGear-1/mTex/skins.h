...
extern void SetSkin(struct nk_context *ctx, enum NKUITheme theme);
extern void InitGWEN();
...
struct NKUISkin media;

void InitGWEN()
{
	media.skin = LoadTexture("skins/gwen.png",0,NULL);
...
void SetSkin(struct nk_context *ctx, enum NKUITheme theme)
{
